...
test_data = []  # try some of the best mcc on the test data and hope for the same kinds of results


def test_with_values(mcc_parameters: dict, finder: BaseFinder) -> List[float, dict]:
    """
